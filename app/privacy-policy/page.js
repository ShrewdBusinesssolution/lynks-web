    ...
    return (
        <div className="container mx-auto my-8 p-8 bg-white rounded shadow-md">
            ...
            <ul>
                ...
                <li>
                    <strong>Application</strong>refers to LynksApp, the software program provided by the Company.
                    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BIZVALLEY INNOVATIONS & RESEARCH PRIVATE LIMITED, Tamil Nadu, India.
                </li>
            ...
            <h2 className="text-2xl font-bold mt-6 mb-4">
                Types of Data Collected <br />Personal Data
            </h2>
            ...
            <p className="mb-4">
                The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:<br /> </p>
                <ul>
            ...
            <p className="mb-4">
                While using Our Application, in order to provide features of Our Application, We may collect, with Your prior permission: </p>
            <ul>
            ...
            <h2 className="text-2xl font-bold mt-6 mb-4">
                Disclosure of Your Personal Data<br />Business Transactions
            </h2>
            <p className="mb-4">
            ...
            <ul>
                <li>
                    By email: info.lynksapp@gmail.com
                </li>
            </ul>
            ...
            <p className="mb-4">
                LynksApp may revise this Privacy Policy from time to time. We will notify users of any changes by updating this page and sending an in-app notification. We encourage users to review this page regularly to stay informed about how we collect, use, and protect their information. If a user disagrees with any changes to the policy, they must discontinue using LynksApp and may request the removal of their personal data. Unless specified otherwise, the revised privacy policy applies to all personal data collected by LynksApp.
            </p>
